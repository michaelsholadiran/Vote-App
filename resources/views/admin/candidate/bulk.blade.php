  	...
  	<main class="ttr-wrapper">
  		<div class="container-fluid">
  			...
  			<div class="row">
                ...
                <div class="col-md-2 ">
            <a href="{{route('admin.candidate.download-csv')}}" class="btn bg-danger">Generate Csv<i class="fa fa-fw fa-plus-circle"></i></a href="">
                </div>
  							<form action="{{route('admin.candidate.upload-bulk')}}"  enctype="multipart/form-data" method="post" class="edit-profile m-b30">
                  @csrf
