  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100 p-l-40 p-r-40 p-t-55 p-b-55">
        <form action="{{ route('voter.login.submit') }}" method="post" class="login100-form validate-form flex-sb flex-w">
              @csrf
          ...
          <div class="wrap-input100 validate-input m-b-36  @error('user_id') alert-validate  @enderror" data-validate="User Id is required">
